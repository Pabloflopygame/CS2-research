  ...
  repeat {
    ...
    if (input %in% c("s")) {
      ...
      for (fichero in ficheros_faltantes) {
        ...
        switch(fichero,
               "./out/data_daily.rds" = {
                 source("./reader_scripts/read_daily_json.R")
               },
               "./out/data_monthly.rds" = {
                 source("./reader_scripts/read_monthly_json.R")
               },
               "./out/data_raw_long.rds" = {
                 source("./reader_scripts/read_raw_json.R")
               },
               "./out/data_weekly-2.rds" = {
                 source("./reader_scripts/read_weekly_2_json.R")
               },
               "./out/data_weekly.rds" = {
                 source("./reader_scripts/read_weekly_json.R")
               }
              )
      }
